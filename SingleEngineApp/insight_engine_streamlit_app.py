...
Provide a friendly web interface for Insight Agent"""
...
def main():
    ...
    st.markdown("Private public opinion database in-depth analysis AI agent")
    st.markdown("Fully automatic 24-hour crawling of public opinion data from 13 social media platforms and technology forums including Weibo, Zhihu, GitHub, Kuan, etc.")
    ...
    max_reflections = 2
    max_content_length = 500000  # Kimi supports long text
    ...
    if start_research:
        ...
        # Automatically use API keys and database configuration from configuration files
        ...
        # Create a Settings configuration (fields must be in uppercase to fit the Settings class)
        config = Settings(

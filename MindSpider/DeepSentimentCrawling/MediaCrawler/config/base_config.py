...
KEYWORDS = "Movie Demon Slayer: Kimetsu no Yaiba, relatives trying to embezzle compensation from the deceased father of three sisters, Internet police cut off the black industry chain of online abuse of minors, people born after 2007 are not allowed to smoke in the Maldives, Shen Yue is a princess and her own knight, video of Israeli military torture of prisoners, records of strange events in the Tang Dynasty, Guangzhou Metro responds to frequent pop-up ads for APP bus codes, Quan Hongchan's weight loss plan is accurate to the gram"  # Keyword search configuration, separated by English commas
...
# Data saving type option configuration, supports five types: csv, db, json, sqlite, postgresql. It is best to save to DB, which has the function of deduplication.
...
CUSTOM_WORDS = {
    "A few cents": "years",  # Recognize "zero points" as a whole
    "high frequency words": "Professional terminology",  # Example custom words
}

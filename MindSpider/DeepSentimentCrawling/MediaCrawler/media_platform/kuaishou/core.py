...
class KuaishouCrawler(AbstractCrawler):
    ...
    async def start(self):
        ...
        async with async_playwright() as playwright:
            ...
            if config.ENABLE_CDP_MODE:
                utils.logger.info("[KuaishouCrawler] Launch the browser using CDP mode")
                ...
                utils.logger.info("[KuaishouCrawler] Launch the browser in standard mode")
    ...
    async def launch_browser_with_cdp(
        ...
        try:
            ...
            utils.logger.info(f"[KuaishouCrawler] CDP browser information: {browser_info}")

            return browser_context

        except Exception as e:
            utils.logger.error(
                f"[KuaishouCrawler] CDP mode startup failed and fell back to standard mode: {e}"
            )

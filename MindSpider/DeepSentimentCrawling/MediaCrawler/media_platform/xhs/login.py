...
class XiaoHongShuLogin(AbstractLogin):
    ...
    async def check_login_state(self, no_logged_in_session: str) -> bool:
        ...
        if "Please pass verification" in await self.context_page.content():
            utils.logger.info("[XiaoHongShuLogin.check_login_state] A verification code appears during the login process, please verify manually")
    ...
    async def login_by_mobile(self):
        ...
        try:
            # After entering the homepage of Xiaohongshu, the login box may not pop up automatically, and you need to manually click the login button.
            login_button_ele = await self.context_page.wait_for_selector(
                selector="xpath=//*[@id='app']/div[1]/div[2]/div[1]/ul/div[1]/button",
                timeout=5000
            )
            await login_button_ele.click()
            # The pop-up login dialog box also has two forms. One is that you can directly see the mobile phone number and verification code.
            # The other is that you need to click to switch to the mobile phone to log in.
        ...
        while max_get_sms_code_time > 0:
            ...
            await agree_privacy_ele.click()  # Click to agree to the privacy agreement
            await asyncio.sleep(0.5)

...
class XiaoHongShuCrawler(AbstractCrawler):
    ...
    async def start(self) -> None:
        ...
        async with async_playwright() as playwright:
            ...
            if config.ENABLE_CDP_MODE:
                utils.logger.info("[XiaoHongShuCrawler] Launch the browser using CDP mode")
                ...
                utils.logger.info("[XiaoHongShuCrawler] Launch the browser in standard mode")
    ...
    async def launch_browser_with_cdp(
        ...
        try:
            ...
            utils.logger.info(f"[XiaoHongShuCrawler] CDP browser information: {browser_info}")

            return browser_context

        except Exception as e:
            utils.logger.error(f"[XiaoHongShuCrawler] CDP mode startup failed and fell back to standard mode: {e}")

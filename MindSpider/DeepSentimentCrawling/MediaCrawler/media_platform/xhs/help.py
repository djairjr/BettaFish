...
def get_trace_id(img_url: str):
    # There are more pictures uploaded on the browser side. The path /spectrum/ is
...
def parse_creator_info_from_url(url: str) -> CreatorUrlInfo:
    """Parsing the creator information from the Xiaohongshu creator homepage URL
    The following formats are supported:
    1. Full URL:"https://www.xiaohongshu.com/user/profile/5eb8e1d400000000010075ae?xsec_token=AB1nWBKCo1vE2HEkfoJUOi5B6BE5n7wVrbdpHoWIj5xHw=&xsec_source=pc_feed"2. Pure ID:"5eb8e1d400000000010075ae"Args:
        url: Creator homepage URL or user_id
    Returns:
        CreatorUrlInfo: object containing user_id, xsec_token, xsec_source"""
    # If it is a pure ID format (24-digit hexadecimal characters), return it directly
    ...
    raise ValueError(f"Unable to parse creator information from URL: {url}")


if __name__ == '__main__':
    _img_url = "https://sns-img-bd.xhscdn.com/7a3abfaf-90c1-a828-5de7-022c80b92aa3"
    # Get the url address of an image address under multiple CDNs
